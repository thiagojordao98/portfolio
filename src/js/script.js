...
function typeWriter() {
  ...
  Olá, tudo bem?
  <br><br>
  Me chamo Thiago Jordão, tenho ${personal.age} anos, sou natural de Parnamirim/RN, tenho graduação em ciências e tecnologia e atualmente estou cursando engenharia da computação pela UFRN, sou apaixonado por tecnologia e quero impactar vidas por meio dela. 
  `];
    ...
    <div class="grid-item" data-animation="bottom">
      ...
      <div class="grid-item-container">
        ...
        <div class="grid-item-buttons">
          <a href="${portfolio[i].site ? portfolio[i].site : 'https://github.com/thiagojordao98'}" target="_blank"><img src="./src/img/social/site.svg" alt="site">Visitar</a>
        </div>
      </div>
...
function sendEmail() {
  ...
  window.location = `mailto:thiagojordao98.com?subject=${subject}&body=${message}%0D%0A%0D%0A${name}%0D%0A${email}`
}
